...
| ID | Rule |
|---|---|
| `BR-CMP-02-001` | Returns generate from live data across `PPL-01`, `PPL-04`, `CORE-02` and `OPS-02`, and **snapshot the data at generation** so a resubmitted return matches what was originally sent. |
...
| `BR-CMP-02-004` | Staff establishment reports approved posts, filled posts, qualifications and vacancies. |
...
| Retention schedules | `CMP-03` | every module | ✅ retro-fitted |

**Every interface opened in Books A through H2 is now closed.**
