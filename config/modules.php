...
return [
    ...
    */
    ...
    'paths' => [
        ...
        */
        'generator' => [
            // Domain/ — the ADR-002 shared-domain layer. No `app/` prefix: see
            // docs/specification/01-volume1-architecture.md §2.3 and Book A §0.
            'actions' => ['path' => 'Domain/Actions', 'generate' => false],
            'casts' => ['path' => 'Domain/Casts', 'generate' => false],
            'channels' => ['path' => 'Domain/Broadcasting', 'generate' => false],
            'class' => ['path' => 'Domain/Support', 'generate' => false],
            'command' => ['path' => 'Console', 'generate' => false],
            'command_replacements' => ['path' => 'Console/Replacements', 'generate' => false],
            'component-class' => ['path' => 'Livewire', 'generate' => false],
            'emails' => ['path' => 'Domain/Emails', 'generate' => false],
            'event' => ['path' => 'Domain/Events', 'generate' => false],
            'enums' => ['path' => 'Domain/Support', 'generate' => false],
            'exceptions' => ['path' => 'Domain/Exceptions', 'generate' => false],
            'jobs' => ['path' => 'Domain/Jobs', 'generate' => false],
            'helpers' => ['path' => 'Domain/Support', 'generate' => false],
            'interfaces' => ['path' => 'Domain/Contracts', 'generate' => false],
            'listener' => ['path' => 'Domain/Listeners', 'generate' => false],
            'model' => ['path' => 'Models', 'generate' => false],
            'notifications' => ['path' => 'Domain/Notifications', 'generate' => false],
            'observer' => ['path' => 'Domain/Observers', 'generate' => false],
            'policies' => ['path' => 'Domain/Policies', 'generate' => false],
            'provider' => ['path' => 'Providers', 'generate' => true],
            'repository' => ['path' => 'Domain/Repositories', 'generate' => false],
            'resource' => ['path' => 'Http/Resources', 'generate' => false],
            'route-provider' => ['path' => 'Providers', 'generate' => true],
            'rules' => ['path' => 'Domain/Rules', 'generate' => false],
            'services' => ['path' => 'Domain/Services', 'generate' => false],
            'scopes' => ['path' => 'Domain/Scopes', 'generate' => false],
            'traits' => ['path' => 'Domain/Concerns', 'generate' => false],
